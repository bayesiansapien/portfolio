          ...
          <div
            ...
            style={{
              ...
              background:
                ...
                'rgba(82,246,197,0) 24%, ' +
                'rgba(82,246,197,0.04) 31%, ' +
                'rgba(82,246,197,0.10) 38%, ' +
                'rgba(82,246,197,0.18) 44%, ' +
                'rgba(82,246,197,0.24) 50%, ' +
                'rgba(82,246,197,0.26) 54%, ' +
                'rgba(82,246,197,0.23) 60%, ' +
                'rgba(82,246,197,0.18) 66%, ' +
                'rgba(82,246,197,0.13) 73%, ' +
                'rgba(82,246,197,0.08) 80%, ' +
                'rgba(82,246,197,0.04) 88%, ' +
                'rgba(82,246,197,0.015) 94%, ' +
