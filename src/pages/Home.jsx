        ...
        <section className="relative grid justify-center pb-12 min-h-[860px] md:min-h-[900px]">
          ...
          <div
            ...
            className={[
              ...
              revealed
                ? 'opacity-0 w-[clamp(360px,60vw,640px)]'
                : 'opacity-100 w-[clamp(380px,64vw,680px)]'
            ].join(' ')}
            style={{
              top: ANCHOR_TOP,
              background:
                'radial-gradient(circle at center, ' +
                'rgba(82,246,197,0) 28%, ' +
                'rgba(82,246,197,0.12) 38%, ' +
                'rgba(82,246,197,0.34) 48%, ' +
                'rgba(82,246,197,0.22) 60%, ' +
                'rgba(82,246,197,0.10) 74%, ' +
                'rgba(82,246,197,0.03) 88%, ' +
